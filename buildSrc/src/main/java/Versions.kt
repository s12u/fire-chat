object Versions {
    ...
    const val KOTLIN_STDLIB = "1.5.31"
    const val KOTLIN_REFLECT = "1.5.31"
    const val COROUTINES = "1.5.1"
    const val COROUTINES_GOOGLE_PLAY = "1.5.1"
    ...
    const val LIFECYCLE_SAVEDSTATE = "2.3.1"

    const val HILT_ANDROID = "2.39.1"
    const val HILT_COMPILER = "2.39.1"
    const val HILT_TESTING = "2.39.1"
    const val HILT_VIEWMODEL = "1.0.0-alpha03"
    const val ANDROIDX_HILT_COMPILER = "1.0.0"

    const val NAVIGATION_UI_KTX = "2.4.0-alpha10"
    const val NAVIGATION_FRAGMENT_KTX = "2.4.0-alpha10"
    const val NAVIGATION_TESTING = "2.4.0-alpha10"

    const val PAGING_RUNTIME_KTX = "3.0.1"
    const val PAGING_COMMON_KTX = "3.0.1"

    const val FIREBASE_AUTH_KTX = "21.0.1"
    const val FIREBASE_FIRESTORE_KTX = "23.0.4"
    const val FIREBASE_STORAGE_KTX = "20.0.0"
    ...
    const val MOCKITO_CORE = "3.11.2"
    const val MOCKITO_KOTLIN = "2.2.0"
    const val HAMCREST = "2.2"

    const val EXT_JUNIT_KTX = "1.1.3"
